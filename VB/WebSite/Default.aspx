...
<body>
	<form id="form1" runat="server">
		<dx:ASPxLabel ID="lbl" runat="server" />
		<dx:ASPxGridView ID="grid" runat="server" DataSourceID="AccessDataSource1" KeyFieldName="OrderID" 
			Width="100%" AutoGenerateColumns="False" OnFilterControlCustomValueDisplayText="grid_FilterControlCustomValueDisplayText" OnFilterControlParseValue="grid_FilterControlParseValue">
			<Columns>
